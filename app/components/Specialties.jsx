...
export default function Specialties() {
  return (
    <section className="mt-24 max-w-6xl mx-auto px-4">
      <h1 className="font-playfair font-semibold text-xl md:text-3xl text-center">
        My Specialties
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-14">
        ...
        {/* CARD */}
        <div className="h-120 sm:h-130 w-full py-6 border flex flex-col justify-between mx-auto">
          <div className="">
            <h2 className="font-playfair px-6 text-lg md:text-[19.456px] font-semibold">
              Anxiety & Panic Therapy
            </h2>
            <p className="font-inter px-6 mt-4 text-sm font-semibold">
